...
import com.example.chat.model.FriendMessage
...
class MessageActivity : AppCompatActivity() {
    ...
    private lateinit var mMsgs: ArrayList<FriendMessage>
        ...
        seenListener = reference.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                for (dataSnapshot in snapshot.children) {
                    val msg: FriendMessage = dataSnapshot.getValue(FriendMessage::class.java)!!
        ...
        reference.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (snapshot: DataSnapshot in dataSnapshot.children) {
                    val msg: FriendMessage = snapshot.getValue(FriendMessage::class.java)!!
